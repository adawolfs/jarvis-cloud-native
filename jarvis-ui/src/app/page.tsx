...
const agent = new RealtimeAgent({
  name: 'JARVIS',
  instructions: 'Eres JARVIS, una interfaz de lenguaje natural para controlar un cluster de kubernetes, resolver dudas sobre cloud native y ayudar al usuario con preguntas sobre kubernetes y otros temas.',
  voice: 'ash',
  tools: [
    refundBackchannel,
    secretTool,
