      ...
      <div>
        <div className="flex flex-col text-sm rounded-[16px]">
          ...
          <div className="bg-[#fafafa] rounded-xl py-2 ml-4 mt-2">
            <div className="max-h-96 overflow-y-scroll dark:text-gray-500 text-xs border-b mx-6 p-2">
              <pre>{input}</pre>
            </div>
            <div className="max-h-80 overflow-y-scroll dark:text-gray-400 mx-6 p-2 text-xs">
              {output ? (
                <pre>{output}</pre>
              ) : (
